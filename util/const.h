...
enum Action {NONE,ENDTURN, MOVE, ATTACK, BUILD, BUILD_BARRACK, BUILD_DEFENSE_TURRET, BUILD_BRIDGE, BUILD_DRILL, BUILD_EXTRACTOR,
            RECRUIT,RECRUIT_SCOUT,RECRUIT_INFANTRY_MELEE,RECRUIT_INFANTRY_DISTANCE,RECRUIT_CAVALRY,RECRUIT_HEAVY,RECRUIT_BALISTIC,
...
const std::map<AssetId,std::vector<int>> UPGRADE_MINERAL_COST = {{BUILDING_DRILL,{2000,3000}},{BUILDING_EXTRACTOR,{5000,7000}},
                                                     {BUILDING_BARRACK,{3000,4000}},{BUILDING_TURRET,{3000}}};
const std::map<AssetId,std::vector<int>> UPGRADE_GAS_COST = {{BUILDING_DRILL,{0,20}},{BUILDING_EXTRACTOR,{10,50}},
                                                     {BUILDING_BARRACK,{0,30}},{BUILDING_TURRET,{20}}};

const std::map<Action, int> UNIT_MINERAL_COST = {{RECRUIT_WORKER,20},{RECRUIT_SCOUT,50},{RECRUIT_INFANTRY_MELEE,100},{RECRUIT_INFANTRY_DISTANCE,150},
                                                 {RECRUIT_CAVALRY,200},{RECRUIT_HEAVY,250},{RECRUIT_BALISTIC,300}};
const std::map<Action, int> UNIT_GAS_COST = {{RECRUIT_WORKER,0},{RECRUIT_SCOUT,0},{RECRUIT_INFANTRY_MELEE,0},{RECRUIT_INFANTRY_DISTANCE,0},
