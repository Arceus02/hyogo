...
enum AssetId {
    ...
    UI_PANEL_BOTTOM, UI_MOVE_BUTTON, UI_ATTACK_BUTTON, UI_BUILD_BUTTON, UI_BUILD_BARRACK, UI_BUILD_BRIDGE,UI_BUILD_DRILL,
    UI_BUILD_EXTRACTOR,UI_BUILD_DEFENSETURRET
};
