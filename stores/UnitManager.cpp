...
void UnitManager::draw(Player player, const ResourceManager &resourceManager, const Vect2D &viewOffset,
    ...
    const UnitStore &currentTurnPlayerUnits = (player == PLAYER1) ? player1Units : player2Units;
    currentTurnPlayerUnits.draw(resourceManager, viewOffset, minRender, maxRender);
}
